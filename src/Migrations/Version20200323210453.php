 ...
 */
final class Version20200323210453 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE xenoblade_mappoints CHANGE maid maid INT DEFAULT NULL');
        $this->addSql('CREATE INDEX IDX_3B7CF95C5FFD247A ON xenoblade_mappoints (maid)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_3B7CF95C5FFD247A ON xenoblade_mappoints');
        $this->addSql('ALTER TABLE xenoblade_mappoints CHANGE maid maid INT NOT NULL');
