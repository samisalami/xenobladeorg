 ...
 */
final class Version20200531062823 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE xenoblade_equip_sockettype_r CHANGE iid iid INT DEFAULT NULL');
        $this->addSql('CREATE INDEX IDX_AC6362ED46A75C12 ON xenoblade_equip_sockettype_r (iid)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_AC6362ED46A75C12 ON xenoblade_equip_sockettype_r');
        $this->addSql('ALTER TABLE xenoblade_equip_sockettype_r CHANGE iid iid INT NOT NULL');
