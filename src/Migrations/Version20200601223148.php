 ...
 */
final class Version20200601223148 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE xenoblade_equip_sockettype_r CHANGE stid stid INT DEFAULT NULL');
        $this->addSql('CREATE INDEX IDX_AC6362EDF5D6654D ON xenoblade_equip_sockettype_r (stid)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_AC6362EDF5D6654D ON xenoblade_equip_sockettype_r');
        $this->addSql('ALTER TABLE xenoblade_equip_sockettype_r CHANGE stid stid INT NOT NULL');
