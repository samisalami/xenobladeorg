 ...
 */
final class Version20200323231018 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_671BE68E3107B339 ON xenoblade_items (colftid)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_671BE68E3107B339 ON xenoblade_items');
