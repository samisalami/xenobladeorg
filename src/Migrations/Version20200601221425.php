 ...
 */
final class Version20200601221425 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE xenoblade_extraskills CHANGE charid charid INT DEFAULT NULL');
        $this->addSql('CREATE INDEX IDX_62D8D687BCEFB92C ON xenoblade_extraskills (charid)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_62D8D687BCEFB92C ON xenoblade_extraskills');
        $this->addSql('ALTER TABLE xenoblade_extraskills CHANGE charid charid INT NOT NULL');
